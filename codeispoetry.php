...
/***** Part 2: Lazy Load Youtube Videos (Load youtube script and video after clicking on the preview image) */
	    ...
	    $(document).ready(function() {
	      $("a.lazy-load-youtube").each(function(index) {
	        ...
	        if(embedparms.indexOf("showinfo=0") != -1)
	          ...
	          $(this).html('<div class="lazy-load-youtube-info">' + $(this).html() + '</div>');
	        $(this).prepend('<div style="height:'+(parseInt($(this).css("height"))-4)+'px;width:'+(parseInt($(this).css("width"))-4)+'px;" class="lazy-load-youtube-div"></div>');
